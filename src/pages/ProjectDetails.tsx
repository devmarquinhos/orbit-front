  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Notas</h2>
          ...
          <ul className="space-y-3">
            {project.notes.map((note) => (
              <li key={note.id}>
                ...
                >
                  {/* Vamos exibir um preview do conteúdo da nota no futuro */}
                  <span className="font-medium text-gray-800">Nota #{note.id}</span>
                </Link>
              </li>
            ))}
          </ul>
